...
@rem     ######################################################
rem      gfortran.exeE½ÌêŠ
set      GNUHOME=C:\MSMPI64\TDM-GCC-64
@rem set      GNUHOME=..\..\..\MSMPI64\TDM-GCC-64
@rem set      GNUHOME=\MSMPI64\TDM-GCC-64

@rem set      MPIHOME="C:\MSMPI64\Microsoft HPC Pack 2008 SDK"
@rem set      MPIHOME="..\..\..\MSMPI64\Microsoft HPC Pack 2008 SDK"
...
set      FCFLAG=-O3 -fconvert=big-endian -I%MPI_INC% -m64 ^
               ...
               -ffixed-line-length-none -malign-double
@rem     ######################################################
