...
!     **                     SpeedCHEM FORTRAN                       **
!     **                                                             **
!     **    Module for MPI communications of sparse matrix algebra   **
!     **                                                             **
!     **                                                             **
...
!        ** Procedures accessible from the outside
...
!        ** The "verbose" routine sets output options for the
...
!        **************************************************************
!        **                                                          **
!        **  Subroutine that initializes the MPI space and returns   **
!        **  the number of processor and the current processor ID    **
!        **                                                          **
!        **************************************************************
...
!        **************************************************************
!        **                                                          **
!        **  Function that computes the flag of the MPI real number  **
!        **  datatype corresponding to the current machine precision **
!        **                                                          **
!        **************************************************************
...
!        **************************************************************
!        **                                                          **
!        **  Broadcast sparse matrix from node 0 to all the other    **
!        **  nodes                                                   **
!        **                                                          **
!        **************************************************************
...
!        Matrix doesn't need to be initialised
...
!        Send sparse matrix dimensions to other nodes
...
!        Other nodes receive matrix dimensions to initialise it
            nrows = sparse_size(1)
            ncols = sparse_size(2)
...
!        Now that all the matrices are initialised, broadcast data
...
!        **************************************************************
!        **                                                          **
!        **  Broadcast sparse_ordered  matrix from node 0 to all     **
!        **  the other nodes, including (if present) information     **
!        **  regarding ordering and factorization                    **
!        **                                                          **
!        **************************************************************
...
!        **************************************************************
!        **                                                          **
!        **  Broadcast double prec matrix from node 0 to all the     **
!        **  other nodes                                             **
!        **                                                          **
!        **************************************************************
...
!        **************************************************************
!        **                                                          **
!        **  Broadcast integer matrix from node 0 to all the         **
!        **  other nodes                                             **
!        **                                                          **
!        **************************************************************
...
!        **************************************************************
!        **                                                          **
!        **  Broadcast double prec array from node 0 to all the      **
!        **  other nodes                                             **
!        **                                                          **
!        **************************************************************
...
!        Broadcast array dimensions to other nodes
...
!           Now that all the arrays are initialised, broadcast data
...
!        **************************************************************
!        **                                                          **
!        **  Broadcast integer array from node 0 to all the          **
!        **  other nodes                                             **
!        **                                                          **
!        **************************************************************
...
!        **************************************************************
!        **                                                          **
!        **  Broadcast integer value from node 0 to all the          **
!        **  other nodes                                             **
!        **                                                          **
!        **************************************************************
...
!        **************************************************************
!        **                                                          **
!        **  Broadcast double precision value from node 0 to all the **
!        **  other nodes                                             **
!        **                                                          **
!        **************************************************************
...
!        **************************************************************
!        **                                                          **
!        **  Broadcast logical value from node 0 to all the nodes    **
!        **                                                          **
!        **************************************************************
...
!        **************************************************************
!        **                                                          **
!        **  Broadcast character string from node 0 to all the nodes **
!        **                                                          **
!        **************************************************************
...
!        **************************************************************
!        **                                                          **
!        **  Broadcast logical array from node 0 to all the          **
!        **  other nodes                                             **
!        **                                                          **
!        **************************************************************
...
!        **************************************************************
!        **                                                          **
!        **  Broadcast character array from node 0 to all the        **
!        **  other nodes                                             **
!        **                                                          **
!        **************************************************************
...
!        **************************************************************
!        **                                                          **
!        **  Broadcast fixed dimension integer array from node 0 to  **
!        **  all the other nodes                                     **
!        **                                                          **
!        **************************************************************
...
!        **************************************************************
!        **                                                          **
!        **  Returns the current node number (from 0 to nprocs-1)    **
!        **                                                          **
!        **************************************************************
